...
**Task** Run the following code and describe the dataframe it outputs. **Answer:** 4 variables and 999 observations.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer:** the unique function removes duplicates of the same word
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer:** splits each word up individually, making there over 64,000+ words.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer:** The resulting graphic shows the word count of each word used. This is not very interesting because they are words used to create sentences they are nothing groundbreaking or unique.
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer:** This code gets rid of what is called the stop words and shows the more interesting words used. The top one being health and following it being support.
...
**Task** Run the following code and describe the results. **Answer:** This code looks at the unique words of each year and gives the top ten.
...
**Task** Run the following code and describe the results. **Answer:** This code is very interesting because it gives the top ten two word for instance covid 19 which would have otherwise not been seen.
...
**Task** Run the following code and describe the results. **Answer:** this looks at the specificity of 2022 in relation to two word phrases.
...
**Task** Run the following code and describe the results. **Answer:** this does the same thing but with 2023 rather than 2022.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer:** Based on first glance the results do not seem incorrect however this is hard to know without the given context.
