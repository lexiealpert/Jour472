...
**Task** Run the following code and describe the dataframe it outputs. **Answer:** The following code displays five variables including how the state voted, population growth, change, and pupil.
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer:** The plot shows the majoirty of points close to the middle with outliers surrounded on the outside.
...
**Task** Run the following code. Describe the plot. What do you see? **Answer:** This code shows more points to the left of the graph with less in the middle and right. However it is hard to tell if there is a substaital relationship between education spending and state here.
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer:** The closer the number is to zero, the less of a relationship there is, this is at -.06 which shows minimal correlation along with -.05, -.04. The closest one is .2 and is positive.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer:** This code shows the answer at -.4 which is negative and low. It also shows a p-value of 0.003 which is extremely low.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer:** This code shows a p-value of 0.6 and a -.05, this proves that it is most likely an anomaly.
...
**Task** Run the following code. Describe the table. What do you see? **Answer:** This code shows a full point difference in GDP. It also shows the mean population growth being a .4 difference.
...
**Task** Run the following code. Describe the output. What do you see? **Answer:** In this we see the Biden Trump mean pop differences again and the p-value at .07 which shows there is correlation.
...
**Task** Run the following code. Describe the output. What do you see? **Answer:** here the p-value is extremely low (less than 0.0002). This shows that there is clearly a pattern available.
