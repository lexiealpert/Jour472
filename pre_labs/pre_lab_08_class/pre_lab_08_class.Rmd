...
**Answer:** The first line is making a new data frame to observe. The second line is making a new column called month and telling R what to put in it. The third like is grouping by month. The fourth line is getting the correct number of total calls. The fifth line is arranging it from highest to lowest.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** The code below creates a graph ranking the months from lowest to highest using ggplot and geom_bar.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer:** The data in both graphs is the same, however this is a different graph that is flipped around.
...
**Task** Run the following code. What do you think this does? **Answer:** I think this code made a new data set with the list of nine. However, im not sure exactly what it is showing.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** This code displays the date and number of calls on that day for 911 calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** This code created a line chart and but the date on the X axis and total calls on the Y axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** this code displays the results of one week. However, these results like the ones prior are a little hard to read without zooming in.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** In this code we see the code turned 45 degreees to remove the overlap. However, the bottom of the graph is not legible.
