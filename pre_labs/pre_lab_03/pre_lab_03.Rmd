...
**Task** Run the following codeblock to count the number of payments. Looking at the result, what jumps out at you as potentially problematic? **Answer: grants are much bigger than the loans**
...
**Task** Run the following code to arrange the grants & loan data so that the smallest amount is first. Describe what you see. **Answer: smallest grant is 60 (which is strange) and then jumps.**
...
Answer: the zip code with the most money from Maryland Tourism Board is 20001. This makes sense as its Washington, D.C., a heavily populated area.
