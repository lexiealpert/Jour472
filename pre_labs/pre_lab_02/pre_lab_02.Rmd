...
**Answer: Its important because the coloum can be worked with later, so doing this ensures you dont lose any of the data selected**
...
**Answer: June had the most expenditures by far, this shows the seasonal variations. (Its converting all the dates into the smallest possible date)**
...
**Answer: The code is creating colums to calculate total votes and Gov. Wes Moores percentage of votes.**
...
**Answer: makes sense most were in Maryland**
...
1.  What is the percent different between Moore and the other candidates?

2.  How many Maryland expenses were above \$1000 ?

3.  How many expenses were the given to the same company (are overlaps)?
