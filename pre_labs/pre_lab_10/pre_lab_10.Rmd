...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer:** A pattern I see is that there is a pretty even rate of each except for in Moco County
