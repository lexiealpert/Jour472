...
A2: biggest was in 2020, which checks out because of pandemic. Could also be an inflation problem. Big issue with the data is that 2016 is missing.
...
A3: examples that should be combined into one: numbers 9&10, 15&16, 6&7
...
**A4**: According to the data below, stem cell research funding has changed in the sense that it decreased by almost half and then increased slightly and now only varies around 20-80 thousand. One thing to point out about the data is that 2016 is not present and neither is 2022 or 2023
