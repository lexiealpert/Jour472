...
-   Atmospheric and Oceanic Science classes
...
-   I find it interesting that public policy only has 3 classes, I would assume it would have more classes that speak about climate
...
-   Business Management - most courses

-   Shows that they dont put there syllabus on Testudo
...
-   the results show that more money was spent in state than out of state.
...
-   Question: How many classes at UMD have a prerequisite?

```{r}
umd_courses |>
  filter(str_detect(description, "prerequisite"))
